/**
 * ARGOS SLOPE 4.0 — BotonCapturaHD.
 *
 * Botón independiente que envía una señal MQTT para iniciar la
 * captura HD del talud (Open3D meshing en el edge).
 *
 * Consume el estado global de MonitorContext.
 */
