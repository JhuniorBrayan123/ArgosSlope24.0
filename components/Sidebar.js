...
const navItems = [
  ...
  { href: '/monitoreo', label: 'Monitoreo en Vivo', icon: <CamaraIcon /> },
  { href: '/visualizacion', label: 'Visualización 3D', icon: <Visual3dIcon /> },
  { href: '/alertas', label: 'Centro de Alertas', icon: <AlertIcon /> },
