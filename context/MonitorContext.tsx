/**
 * ARGOS SLOPE 4.0 — MonitorContext (Estado Global).
 *
 * Provider que envuelve toda la aplicación. Mantiene:
 *   - Conexión MQTT (WebSocket → HiveMQ Cloud)
 *   - Estado de WebRTC (cámara en vivo)
 *   - Array de alertas recibidas (fisuras + capturas HD)
 *   - Última nube de puntos 3D recibida
 *   - Capturas HD disponibles para visualizar
 *
 * Los servicios se conectan UNA SOLA VEZ al montar la app y viven
 * en el Provider, sin importar por qué ruta navegue el usuario.
 */
