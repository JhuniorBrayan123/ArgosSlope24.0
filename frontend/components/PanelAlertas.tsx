              ...
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1.5 flex items-center gap-3 text-[11px] text-dark-secondary">
                    ...
                    <span>
                      {alerta.tipo === 'critico' || alerta.tipo === 'advertencia'
                        ? `Valor: ${alerta.valor_actual.toFixed(2)} mm/día | Umbral: ${alerta.umbral_superado.toFixed(1)} mm/día`
                        : `Valor: ${alerta.valor_actual.toFixed(2)}% | Umbral: ${alerta.umbral_superado.toFixed(1)}%`
                      }
                    </span>
                  </div>
                </div>
